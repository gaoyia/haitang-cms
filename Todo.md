...
| 状态 | 功能 | 目标 | 待定点 | 验收 |
|------|------|------|--------|------|
| ✅ | 文章置顶 | 文章可标记置顶；列表整体按「置顶优先 → 展示时间新→旧」排好后**正常分页** | `post_meta.pinned`；`sort_post_metas_for_list`；管理端表单开关与列表标识；公开 API / Tera / RSS | 例：page_size=5、置顶 6 条 → 第 1 页 5 条置顶；第 2 页 1 条置顶 + 4 条非置顶；第 3 页起全非置顶 |
