...
onMounted(() => {
  ...
  console.log(
    `%c 海棠 CMS %c 管理后台 `,
    "padding: 2px 1px; border-radius: 3px 0 0 3px; color: #fff; background: #b7102a; font-weight: bold;",
    "padding: 2px 1px; border-radius: 0 3px 3px 0; color: #fff; background: #46634c; font-weight: bold;"
  );
});
