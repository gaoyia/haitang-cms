export default {
  ...
  menu: {
    ...
    banner: {
      ...
      heroTitle: "Headline",
      heroTitlePh: "e.g. Let content shine like <em>morning light</em> 🎉",
      heroTitleHint: "Wrap the emphasized phrase with em tags; Chinese titles often use corner quotes inside em, e.g. 让…如<em>「phrase」</em>…",
