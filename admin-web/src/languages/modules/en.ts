export default {
  ...
  menu: {
    ...
    content: {
      ...
      post: {
        manage: {
          ...
          assetsNeedSave: "Save the post before uploading cover or attachments",
          cover: "Cover",
          coverHint: "Covers are shared across locales; images only; up to {max} (dict post_cover_max)",
          coverLimitReached: "Cover limit reached ({max})",
          attachments: "Attachments",
          attachmentsHint: "Multiple attachments; images, videos, archives, and Office documents",
      ...
      category: {
        title: "Categories",
        subtitle: "Manage post categories with multilingual names and descriptions",
        previewLang: "Preview language",
        name: "Name",
    ...
    assets: {
      ...
      pickerUploadHint: "After upload, the new file is selected automatically",
    },
    banner: {
      auth: "Banners",
