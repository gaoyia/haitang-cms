export default {
  ...
  menu: {
    ...
    content: {
      ...
      post: {
        manage: {
          ...
          pinned: "Pinned",
          pinnedYes: "Pinned",
          pinnedHint: "Pinned posts appear first; within each group, order by display time",
    ...
    banner: {
      ...
      adminTitleHint: "Shown in admin lists only; configure homepage Hero copy per locale below",
      linkHint: "Optional click-through for the whole slide; button URLs are configured separately below",
      heroSection: "Homepage Hero copy",
      heroSectionHint: "Configure badge, title, description, tags, and buttons per locale; each button needs label and URL",
      heroBadge: "Badge",
      heroBadgePh: "e.g. Structured elegance",
      heroTitle: "Headline",
      heroTitlePh: "e.g. Let content shine like {emOpen}morning light{emClose} 🎉",
      heroTitleHint: "Wrap the emphasized phrase with em tags; Chinese titles often use corner quotes inside em, e.g. 让…如{emOpen}「phrase」{emClose}…",
      heroDesc: "Description",
      heroDescPh: "Hero subtitle copy",
      heroTags: "Tags",
      heroTagPh: "Type and press Enter or Add",
      heroTagAdd: "Add",
      heroTagsHint: "Shown as a tag group; add multiple items",
      heroActions: "Buttons",
      heroActionLabelPh: "Button label",
      heroActionUrlPh: "Link URL (site path or https://)",
      heroActionPrimary: "Primary",
      heroActionSecondary: "Secondary",
      heroActionAdd: "Add button",
      heroActionsHint: "Each button has a label and link URL; you can add several",
    },
    friendLink: {
      auth: "Friend links",
      title: "Name",
      titlePh: "Site name for image alt text",
      titleRequired: "Name is required",
      url: "URL",
      urlPh: "https://example.com",
      urlRequired: "URL is required",
      image: "Badge image",
      imageHint: "Pick an asset with purpose Friend link, or upload one first",
      imageRequired: "Please select a friend link image",
      pickerTitle: "Select friend link image",
      sort: "Sort",
      create: "New friend link",
      edit: "Edit friend link",
      listEmpty: "No friend links yet",
      deleteConfirm: "Delete friend link \"{name}\"?",
      manage: {
        title: "Friend links",
        subtitle: "Manage footer friend links shown on the public site",
        dragSort: "Drag to reorder",
      },
    },
    menu: {
